...
1. Household median income by Census Tract (Done)
2. School quality score:
- MCAS standardized scores (TBD)
- Graduation rates
...
# School District to Town crosswalk
...
#      "<strong>Tract:</strong> ", NAME, "<br/>",
      ...
      "<strong>MCAS Percentile:</strong> ", ifelse(is.na(exceed_mcas_percentile), "NA", paste0(exceed_mcas_percentile,"%"), "<br/>",      
