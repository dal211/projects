...
const LESSON_THEMES = {
    ...
    3: {
        ...
        6: { title: "Calculations & Hobbies", desc: "Simple, Music, Math, Draw" },
        7: { title: "Meeting Old Friends", desc: "Meet up, Past, Change, Principal" },
        8: { title: "Habits & Problems", desc: "Late, Habit, Problem, Solve" },
        9: { title: "Environment & City", desc: "Environment, City, Directions" },
        10: { title: "History & Culture", desc: "History, Story, Famous, Culture" },
        11: { title: "Meetings & Work", desc: "Meeting, Finish, Library, Borrow" },
        12: { title: "Seasons & Change", desc: "Autumn, Winter, Windy, Health" },
        13: { title: "Shopping & Choices", desc: "Choice, Online, Convenient" },
        14: { title: "Festivals & Events", desc: "Festival, Hold, Participate" },
        15: { title: "Animals & Nature", desc: "Animal, Bird, Panda, Moon" },
        16: { title: "Household & Chores", desc: "Clean, Bath, Brush teeth" },
        17: { title: "Expressing Opinions", desc: "Think, Agree, Oppose, Opinion" },
        18: { title: "Emotions & States", desc: "Angry, Cry, Laugh, Sad, Worried" },
        19: { title: "Travel & Banking", desc: "Passport, Suitcase, Bank" },
        20: { title: "Conclusion & Success", desc: "Finally, Success, Score, Improve" },
    },
    4: {
        ...
        6: { title: "Technology & Devices", desc: "Computer, Internet, Password" },
        7: { title: "Environment & Nature", desc: "Pollution, Recycle, Climate" },
        8: { title: "Education & Learning", desc: "Major, Research, Scholarship" },
        9: { title: "Law & Justice", desc: "Lawyer, Evidence, Fairness" },
        10: { title: "Social Issues", desc: "Unemployment, Poverty, Development" },
        11: { title: "Advanced Travel", desc: "Itinerary, Scenic, Backpacker" },
        12: { title: "Media & Entertainment", desc: "News, Celebrity, Advertisement" },
        13: { title: "Science & Discovery", desc: "Discovery, Experiment, Theory" },
        14: { title: "Economy & Business", desc: "Investment, Trade, Profit" },
        15: { title: "Review & Integration", desc: "Summary, Goal, Confidence" },
    },
    5: {
        ...
        6: { title: "Economics & Finance", desc: "Inflation, Profit, Budget, Spend" },
        7: { title: "Psychology & Emotion", desc: "Anxiety, Stress, Optimistic" },
        8: { title: "Modern Lifestyle", desc: "Balance, Leisure, Tech, Trend" },
        9: { title: "Arts & Humanities", desc: "Aesthetics, Inspiration, Tradition" },
        10: { title: "Science & Logic", desc: "Logic, Hypothesis, Analysis" },
        11: { title: "Workplace & Career", desc: "Promotion, Interview, Benefit" },
        12: { title: "Globalization", desc: "Global, Identity, Fusion, Gap" },
        13: { title: "Health & Wellness", desc: "Symptom, Prevention, Recover" },
        14: { title: "Philosophy & Thought", desc: "Values, Morality, Fate, Essence" },
        15: { title: "Mastery & Integration", desc: "Profound, Skill, Achievement" },
    },
    6: {
        ...
        6: { title: "Politics & Gov", desc: "Constitution, Democracy, Reform" },
        7: { title: "Classical Lit", desc: "Poetry, Rhetoric, Artistic mood" },
        8: { title: "Advanced Philosophy", desc: "Materialism, Dialectics, Truth" },
        9: { title: "Social Resp", desc: "Duty, Harmony, Sustainability" },
        10: { title: "Engineering & Tech", desc: "Patent, Cutting-edge, Smart city" },
        11: { title: "Int'l Relations", desc: "Diplomacy, Alliance, Negotiation" },
        12: { title: "Historical Analysis", desc: "Relics, Inheritance, Reflection" },
        13: { title: "Aesthetic Criticism", desc: "Connoisseur, Realm, Resonance" },
        14: { title: "Logic & Rhetoric", desc: "Premise, Deduction, Paradox" },
        15: { title: "Academic Mastery", desc: "Academic, Explore, Proficient" },
    }
};
